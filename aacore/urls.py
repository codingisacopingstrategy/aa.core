...
urlpatterns = patterns('aacore.views',
    ...
    url(r'^pages/(?P<slug>[-\w]+)/edit/(?P<id>\d+)/$', 'page_edit_section', {}, name='aa-page-edit-section'),
    url(r'^pages/(?P<slug>[-\w]+)/edit/geometry/$', 'page_edit_geometry', {}, name='aa-page-edit-geometry'),
